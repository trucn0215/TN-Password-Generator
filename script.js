...
function generatePassword(){
  ...
  // When user putting letters or empty then give alert to provide a number
  ...
  // When input number out of range, then give an alert to input a number within the range
